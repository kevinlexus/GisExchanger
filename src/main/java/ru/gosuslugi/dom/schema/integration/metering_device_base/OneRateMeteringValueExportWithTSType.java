...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.device_metering.OneRateMeteringValueExportType.class
})
public class OneRateMeteringValueExportWithTSType
    extends ru.gosuslugi.dom.schema.integration.metering_device_base.OneRateMeteringValueExportType
{
