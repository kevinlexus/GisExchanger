 ...
 *                             &lt;element name="GeneralMunicipalResource" type="{http://dom.gosuslugi.ru/schema/integration/bills/}GeneralMunicipalResourceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                           &lt;/sequence&gt;
 *                         &lt;/restriction&gt;
 *                       &lt;/complexContent&gt;
 *                     &lt;/complexType&gt;
...
public class PDServiceChargeType {
    ...
    public static class GroupMunicipalService {
        ...
        public List<PDServiceChargeType.GroupMunicipalService.MunicipalService> getMunicipalService() {
            if (municipalService == null) {
                municipalService = new ArrayList<PDServiceChargeType.GroupMunicipalService.MunicipalService>();
            }
            ...
            extends ServicePDImportType
        {
            ...
            public static class Consumption {
                ...
                public List<PDServiceChargeType.GroupMunicipalService.MunicipalService.Consumption.Volume> getVolume() {
                    if (volume == null) {
                        volume = new ArrayList<PDServiceChargeType.GroupMunicipalService.MunicipalService.Consumption.Volume>();
                    }
                    return this.volume;
                }
        ...
        extends ServicePDImportType
    {
        ...
        public static class MunicipalResource {
            ...
            protected List<GeneralMunicipalResourceType> generalMunicipalResource;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link GeneralMunicipalResourceType }
             * 
             * 
             */
            public List<GeneralMunicipalResourceType> getGeneralMunicipalResource() {
                if (generalMunicipalResource == null) {
                    generalMunicipalResource = new ArrayList<GeneralMunicipalResourceType>();
                }
