 ...
 * 
 */
@WebServiceClient(name = "MSPAsyncService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/msp-service-async/", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/msp/hcs-msp-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/msp/hcs-msp-service-async.wsdl");
