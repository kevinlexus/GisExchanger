...
import ru.gosuslugi.dom.schema.integration.house_management.ExportBriefSocialHireContractResult;
import ru.gosuslugi.dom.schema.integration.house_management.ExportBriefSupplyResourceContractRequest;
import ru.gosuslugi.dom.schema.integration.house_management.ExportBriefSupplyResourceContractResult;
...
import ru.gosuslugi.dom.schema.integration.house_management.ExportSupplyResourceContractObjectAddressResult;
...
public interface HouseManagementPortsType {
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.house_management.ExportSupplyResourceContractObjectAddressResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportSupplyResourceContractObjectAddressData")
    @WebResult(name = "exportSupplyResourceContractObjectAddressResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportSupplyResourceContractObjectAddressResult")
    public ExportSupplyResourceContractObjectAddressResult exportSupplyResourceContractObjectAddressData(
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "importSupplyResourceContractObjectAddressResult")
    public ru.gosuslugi.dom.schema.integration.base.ImportResult importSupplyResourceContractObjectAddressData(
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "importSupplyResourceContractProjectResult")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.house_management.ExportBriefSupplyResourceContractResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportBriefSupplyResourceContract")
    @WebResult(name = "exportBriefSupplyResourceContractResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportBriefSupplyResourceContractResult")
    public ExportBriefSupplyResourceContractResult exportBriefSupplyResourceContract(
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.house_management.ExportBriefSocialHireContractResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportBriefSocialHireContract")
    @WebResult(name = "exportBriefSocialHireContractResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportBriefSocialHireContractResult")
    public ExportBriefSocialHireContractResult exportBriefSocialHireContract(
