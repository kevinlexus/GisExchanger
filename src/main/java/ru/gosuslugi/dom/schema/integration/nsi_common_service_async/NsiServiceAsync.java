 ...
 * 
 */
@WebServiceClient(name = "NsiServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/nsi-common-service-async/", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/nsi-common/hcs-nsi-common-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/nsi-common/hcs-nsi-common-service-async.wsdl");
