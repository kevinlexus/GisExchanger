    ...
    extends BaseType
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the notificationOfOrderExecution139Type property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<ImportNotificationsOfOrderExecutionRequest.NotificationOfOrderExecution139Type> getNotificationOfOrderExecution139Type() {
        if (notificationOfOrderExecution139Type == null) {
            notificationOfOrderExecution139Type = new ArrayList<ImportNotificationsOfOrderExecutionRequest.NotificationOfOrderExecution139Type>();
        }
