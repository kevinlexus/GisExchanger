 ...
 *
 */
@WebServiceClient(name = "DeviceMeteringService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/device-metering-service/", wsdlLocation = "file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/device-metering/hcs-device-metering-service.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/device-metering/hcs-device-metering-service.wsdl");
