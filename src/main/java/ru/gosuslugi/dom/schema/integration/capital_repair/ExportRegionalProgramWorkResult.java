 ...
 *         &lt;element name="RegionalProgramWork" type="{http://dom.gosuslugi.ru/schema/integration/capital-repair/}ExportRegionalProgramWorkType" maxOccurs="unbounded"/>
 *       &lt;/choice>
...
@XmlRootElement(name = "exportRegionalProgramWorkResult")
public class ExportRegionalProgramWorkResult
    extends BaseType
{
