 ...
 *
 */
@WebServiceClient(name = "LicenseService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/licenses-service/", wsdlLocation = "file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/licenses/hcs-licenses-service.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/licenses/hcs-licenses-service.wsdl");
