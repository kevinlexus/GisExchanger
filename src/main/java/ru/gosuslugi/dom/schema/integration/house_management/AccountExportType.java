...
/**
 * <p>Java class for AccountExportType complex type.
 * 
...
public class AccountExportType {
    ...
    public List<AccountExportType.Accommodation> getAccommodation() {
        if (accommodation == null) {
            accommodation = new ArrayList<AccountExportType.Accommodation>();
        }
    ...
    public static class PayerInfo {
        ...
        /**
         * Gets the value of the isAccountsDivided property.
         * 
         * @return
         *     possible object is
         *     {@link Boolean }
