 ...
 * 
 */
@WebServiceClient(name = "LicenseServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/licenses-service-async/", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/licenses/hcs-licenses-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/licenses/hcs-licenses-service-async.wsdl");
