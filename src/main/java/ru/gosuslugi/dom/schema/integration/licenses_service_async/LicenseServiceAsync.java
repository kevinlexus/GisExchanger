 ...
 * 
 */
@WebServiceClient(name = "LicenseServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/licenses-service-async/", wsdlLocation = "file:/C:/work/GIS_MUP/GIS11.5.0.8/hcs_wsdl_xsd_v.11.5.0.8/licenses/hcs-licenses-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/work/GIS_MUP/GIS11.5.0.8/hcs_wsdl_xsd_v.11.5.0.8/licenses/hcs-licenses-service-async.wsdl");
