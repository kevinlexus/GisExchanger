 ...
 * 
 */
@WebServiceClient(name = "RapServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/rap-service-async/", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/rap/hcs-rap-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/rap/hcs-rap-service-async.wsdl");
