    ...
    extends BaseAsyncResponseType
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the exportURIExaminationStateResult property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<ExportExaminationURIStateResultType> getExportURIExaminationStateResult() {
        if (exportURIExaminationStateResult == null) {
            exportURIExaminationStateResult = new ArrayList<ExportExaminationURIStateResultType>();
        }
