 ...
 *
 */
@WebServiceClient(name = "InfrastructureService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/infrastructure-service/", wsdlLocation = "file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/infrastructure/hcs-infrastructure-service.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/infrastructure/hcs-infrastructure-service.wsdl");
