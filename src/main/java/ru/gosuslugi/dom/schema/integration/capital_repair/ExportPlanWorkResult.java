 ...
 *         &lt;element name="PlanWork" type="{http://dom.gosuslugi.ru/schema/integration/capital-repair/}ExportWorkPlanType" maxOccurs="unbounded"/>
 *       &lt;/choice>
...
@XmlRootElement(name = "exportPlanWorkResult")
public class ExportPlanWorkResult
    extends BaseType
{
