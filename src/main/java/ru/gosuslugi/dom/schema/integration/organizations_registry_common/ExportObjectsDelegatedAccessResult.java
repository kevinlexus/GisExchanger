 ...
 *         &lt;sequence>
 *           &lt;element name="DelegatedAccessRight" type="{http://dom.gosuslugi.ru/schema/integration/organizations-registry-common/}ObjectsDelegatedAccessRightType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "exportObjectsDelegatedAccessResult")
public class ExportObjectsDelegatedAccessResult
    extends BaseType
{
    ...
    protected List<ObjectsDelegatedAccessRightType> delegatedAccessRight;
     ...
     * 
     */
    public List<ObjectsDelegatedAccessRightType> getDelegatedAccessRight() {
        if (delegatedAccessRight == null) {
            delegatedAccessRight = new ArrayList<ObjectsDelegatedAccessRightType>();
        }
