 ...
 * 
 * <p>Java class for ExportOneRateMeteringValueKindType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ExportOneRateMeteringValueKindType">
 *   &lt;complexContent>
 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/metering-device-base/}ExportOneRateMeteringValueType">
 *                 &lt;sequence>
 ...
 *                   &lt;element name="StartValue" type="{http://dom.gosuslugi.ru/schema/integration/metering-device-base/}ExportOneRateMeteringValueType" maxOccurs="3"/>
 *                   &lt;element name="EndValue" type="{http://dom.gosuslugi.ru/schema/integration/metering-device-base/}ExportOneRateMeteringValueType" maxOccurs="3"/>
 *                   &lt;choice>
...
@XmlType(name = "ExportOneRateMeteringValueKindType", propOrder = {
    "currentValue",
    "controlValue",
    "verificationValue"
})
...
public class ExportOneRateMeteringValueKindType {
    ...
    protected List<ExportOneRateMeteringValueKindType.CurrentValue> currentValue;
    @XmlElement(name = "ControlValue")
    protected List<ExportOneRateMeteringValueKindType.ControlValue> controlValue;
    @XmlElement(name = "VerificationValue")
    protected List<ExportOneRateMeteringValueKindType.VerificationValue> verificationValue;
     ...
     * {@link ExportOneRateMeteringValueKindType.CurrentValue }
     * 
     * 
     */
    public List<ExportOneRateMeteringValueKindType.CurrentValue> getCurrentValue() {
        if (currentValue == null) {
            currentValue = new ArrayList<ExportOneRateMeteringValueKindType.CurrentValue>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExportOneRateMeteringValueKindType.ControlValue }
     * 
     * 
     */
    public List<ExportOneRateMeteringValueKindType.ControlValue> getControlValue() {
        if (controlValue == null) {
            controlValue = new ArrayList<ExportOneRateMeteringValueKindType.ControlValue>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExportOneRateMeteringValueKindType.VerificationValue }
     * 
     * 
     */
    public List<ExportOneRateMeteringValueKindType.VerificationValue> getVerificationValue() {
        if (verificationValue == null) {
            verificationValue = new ArrayList<ExportOneRateMeteringValueKindType.VerificationValue>();
        }
    ...
    public static class ControlValue
        extends ExportOneRateMeteringValueType
    {
    ...
    public static class VerificationValue {
        ...
        protected List<ExportOneRateMeteringValueType> startValue;
        @XmlElement(name = "EndValue", required = true)
        protected List<ExportOneRateMeteringValueType> endValue;
         ...
         * 
         */
        public List<ExportOneRateMeteringValueType> getStartValue() {
            if (startValue == null) {
                startValue = new ArrayList<ExportOneRateMeteringValueType>();
            }
         ...
         * 
         */
        public List<ExportOneRateMeteringValueType> getEndValue() {
            if (endValue == null) {
                endValue = new ArrayList<ExportOneRateMeteringValueType>();
            }
