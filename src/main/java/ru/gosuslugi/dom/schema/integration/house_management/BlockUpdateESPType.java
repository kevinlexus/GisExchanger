...
/**
 * Блок дома блокированной застройки  (обновление данных для ЕСП)
 * 
 * <p>Java class for BlockUpdateESPType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BlockUpdateESPType">
 *   &lt;complexContent>
...
@XmlType(name = "BlockUpdateESPType", propOrder = {
    "blockNum",
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.house_management.ImportHouseESPRequest.LivingHouse.Blocks.BlockToUpdate.class
})
public class BlockUpdateESPType
