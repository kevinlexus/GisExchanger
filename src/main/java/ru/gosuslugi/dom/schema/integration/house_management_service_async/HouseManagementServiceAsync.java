 ...
 * 
 */
@WebServiceClient(name = "HouseManagementServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management-service-async/", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/house-management/META-INF/wsdl/hcs-house-management-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/house-management/META-INF/wsdl/hcs-house-management-service-async.wsdl");
