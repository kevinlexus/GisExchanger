 ...
 * 
 */
@WebServiceClient(name = "HouseManagementServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management-service-async/", wsdlLocation = "file:/C:/work/GIS_MUP/GIS11.5.0.8/hcs_wsdl_xsd_v.11.5.0.8/house-management/hcs-house-management-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/work/GIS_MUP/GIS11.5.0.8/hcs_wsdl_xsd_v.11.5.0.8/house-management/hcs-house-management-service-async.wsdl");
