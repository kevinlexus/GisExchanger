 ...
 *
 */
@WebServiceClient(name = "CapitalRepairService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/capital-repair-service/", wsdlLocation = "file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/capital-repair/hcs-capital-repair-service.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Progs/GisExchanger/wsdl/hcs_wsdl_xsd_v.11.13.0.11/capital-repair/hcs-capital-repair-service.wsdl");
