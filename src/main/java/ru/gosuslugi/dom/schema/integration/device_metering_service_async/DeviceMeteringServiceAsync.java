 ...
 * 
 */
@WebServiceClient(name = "DeviceMeteringServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/device-metering-service-async/", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/device-metering/META-INF/wsdl/hcs-device-metering-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/device-metering/META-INF/wsdl/hcs-device-metering-service-async.wsdl");
