...
/**
 * Блок дома блокированной застройки  (для импорта от ЕСП)
 * 
 * <p>Java class for BlockESPType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BlockESPType">
 *   &lt;complexContent>
...
@XmlType(name = "BlockESPType", propOrder = {
    "blockNum",
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.house_management.ImportHouseESPRequest.LivingHouse.Blocks.BlockToCreate.class
})
public class BlockESPType
