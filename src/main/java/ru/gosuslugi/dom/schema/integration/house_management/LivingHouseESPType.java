...
/**
 * Жилой дом (для импорта от ЕСП)
 * 
 * <p>Java class for LivingHouseESPType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LivingHouseESPType">
 *   &lt;complexContent>
...
@XmlType(name = "LivingHouseESPType", propOrder = {
    "basicCharacteristicts",
    "hasBlocks"
})
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.house_management.ImportHouseESPRequest.LivingHouse.LivingHouseToCreate.class
})
public class LivingHouseESPType {

    @XmlElement(name = "BasicCharacteristicts", required = true)
    protected LivingHouseESPType.BasicCharacteristicts basicCharacteristicts;
     ...
     * @return
     *     possible object is
     *     {@link LivingHouseESPType.BasicCharacteristicts }
     *     
     */
    public LivingHouseESPType.BasicCharacteristicts getBasicCharacteristicts() {
     ...
     *     
     */
    public void setBasicCharacteristicts(LivingHouseESPType.BasicCharacteristicts value) {
