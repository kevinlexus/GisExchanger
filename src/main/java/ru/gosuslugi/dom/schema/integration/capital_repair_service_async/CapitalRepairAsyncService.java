 ...
 * 
 */
@WebServiceClient(name = "CapitalRepairAsyncService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/capital-repair-service-async/", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/capital-repair/META-INF/wsdl/hcs-capital-repair-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/capital-repair/META-INF/wsdl/hcs-capital-repair-service-async.wsdl");
