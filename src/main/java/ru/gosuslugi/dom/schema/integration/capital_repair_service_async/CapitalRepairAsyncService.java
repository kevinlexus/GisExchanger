 ...
 * 
 */
@WebServiceClient(name = "CapitalRepairAsyncService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/capital-repair-service-async/", wsdlLocation = "file:/C:/Progs/Soap2Gis/wsdl/hcs_wsdl_xsd_v.11.13.0.11/capital-repair/hcs-capital-repair-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Progs/Soap2Gis/wsdl/hcs_wsdl_xsd_v.11.13.0.11/capital-repair/hcs-capital-repair-service-async.wsdl");
