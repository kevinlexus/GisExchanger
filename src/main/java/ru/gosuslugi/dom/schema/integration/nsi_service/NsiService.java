 ...
 * 
 */
@WebServiceClient(name = "NsiService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/nsi-service/", wsdlLocation = "file:/C:/work/GIS_MUP/GIS11.5.0.8/hcs_wsdl_xsd_v.11.5.0.8/nsi/hcs-nsi-service.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/work/GIS_MUP/GIS11.5.0.8/hcs_wsdl_xsd_v.11.5.0.8/nsi/hcs-nsi-service.wsdl");
