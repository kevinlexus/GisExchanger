 ...
 * 
 */
@WebServiceClient(name = "AppealsServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/appeals-service-async", wsdlLocation = "file:/C:/doc/GIS/gis_wsimport/appeals/META-INF/wsdl/hcs-appeals-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/doc/GIS/gis_wsimport/appeals/META-INF/wsdl/hcs-appeals-service-async.wsdl");
