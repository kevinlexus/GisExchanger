...
import ru.gosuslugi.dom.schema.integration.inspection.ExportExaminationURIStateResult;
...
public interface InspectionPortsType {
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.inspection.ExportExaminationURIStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportExaminationURIState")
    @WebResult(name = "exportExaminationURIStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/inspection/", partName = "exportExaminationURIStateResult")
    public ExportExaminationURIStateResult exportExaminationURIState(
